...
- 지난 프리코스 [1주](/docs/archive/development-guide/week-1-feedback.md), [2주](/docs/archive/development-guide/week-2-feedback.md), [3주](/docs/archive/development-guide/week-3-feedback.md)차 피드백을 준수한다. (아래 요약)
    ...
    - 지난 프리코스와 같이 [AngularJS Git Commit Message Conventions](https://gist.github.com/stephenparish/9941e89d80e2bc58a153), [Java Style Guide](/docs/archive/development-guide/java_style_guide.md)을 준수한다.
...
<img alt="사용시연.gif" height="700" src="/docs/archive/img/사용시연.gif" width="700"/>
